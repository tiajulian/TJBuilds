const groups = [
  {
    ...
    badgeClass:
      "bg-indigo-500/5 text-indigo-300 border-indigo-500/15",
  ...
  },
  {
    ...
    badgeClass:
      "bg-violet-500/5 text-violet-300 border-violet-500/15",
  ...
  },
  {
    ...
    badgeClass:
      "bg-pink-500/5 text-pink-300 border-pink-500/15",
    skills: [
      "Computer Vision",
      "Object Detection",
      "Image Recognition",
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {groups.map((group) => (
            <div
              key={group.label}
              className="bg-[#12131e] border border-white/5 rounded-2xl p-6 hover:border-white/10 transition-colors"
            >
